...
Public Class Admin
    ...
    Private Sub Update_Click(sender As Object, e As EventArgs) Handles gradeUpdatebtn.Click
        ...
        If CRNComboBox.Text = "Choose One" Or SemesterComboBox.Text = "Choose One" Then
            MessageBox.Show("Please choose atleast one option from CRN and Semester Field")
        Else
            Me.Hide()
            updateForm.Show()
        End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Delete.Click
        ...
        Try
            ...
            Dim query1 = "DELETE FROM student_data WHERE Student_Data.Student_Id = '" & StudentIDtxt.Text & "';"
            COMMAND = New MySqlCommand(query1, MysqlConn)
            READER1 = COMMAND.ExecuteReader
            READER1.Dispose()
            COMMAND.Dispose()
            ...
            Dim query2 = "DELETE FROM student_schedule WHERE student_schedule.Student_Id = '" & StudentIDtxt.Text & "';"
            COMMAND = New MySqlCommand(query2, MysqlConn)
            READER1 = COMMAND.ExecuteReader
            READER1.Dispose()
            COMMAND.Dispose()
            ...
            Dim query3 = "DELETE FROM grade_record WHERE grade_record.Student_Id = '" & StudentIDtxt.Text & "';"
            COMMAND = New MySqlCommand(query3, MysqlConn)
            READER1 = COMMAND.ExecuteReader
            READER1.Dispose()
            COMMAND.Dispose()

            Dim query4 = "DELETE FROM gpa_data WHERE gpa_data.Student_Id = '" & StudentIDtxt.Text & "';"
    ...
    Private Sub GPAlbl_Click(sender As Object, e As EventArgs) Handles GPAlbl.Click
